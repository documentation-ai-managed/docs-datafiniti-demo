---
title: Business Data with Postman and CSV
---
...
<ParamField path="/v3" param-type="string" required="false" deprecated="false">
  You're telling the API which version to use.  `v3` is our most recent and current API version.
</ParamField>

<ParamField path="/data" param-type="string" required="false" deprecated="false">
  You're telling the API you're interested in querying data.
</ParamField>

<ParamField path="/businesses" param-type="string" required="false" deprecated="false">
  Specifically, you're interested in business data.
</ParamField>

<ParamField query="view" param-type="string" required="false" deprecated="false">
...
<ParamField query="q" param-type="string" required="false" deprecated="false">
...
<ParamField query="records" param-type="integer" required="false" deprecated="false">
  The `records` tells the API how many records to return in its response.  In this case, you just want to see 1 matching record.

  **Example:** `records=1`
</ParamField>

<ParamField query="download" param-type="boolean" required="false" deprecated="false">
...
<ResponseField name="estimated_total" field-type="string" required="false" deprecated="false">
...
<ResponseField name="dataType" field-type="string" required="false" deprecated="false">
  The data type you queried.
</ResponseField>

<ResponseField name="dataFormat" field-type="string" required="false" deprecated="false">
  The data format you requested.
</ResponseField>

<ResponseField name="accountId" field-type="string" required="false" deprecated="false">
  Your API token.
</ResponseField>

<ResponseField name="planId" field-type="string" required="false" deprecated="false">
  The Datafiniti plan level you're using.
</ResponseField>

<ResponseField name="view" field-type="string" required="false" deprecated="false">
  The view you chose.  This determines which fields are shown in the data.
</ResponseField>

<ResponseField name="async" field-type="string" required="false" deprecated="false">
...
<ResponseField name="numDownloaded" field-type="string" required="false" deprecated="false">
  The number of records that have been downloaded so far.
</ResponseField>

<ResponseField name="numFound" field-type="string" required="false" deprecated="false">
  The number of total records in Datafiniti that matched your query.
</ResponseField>

<ResponseField name="numRequested" field-type="string" required="false" deprecated="false">
...
<ResponseField name="date_completed" field-type="string" required="false" deprecated="false">
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452660911-g35o3vp784-a7b5fae-hotel_sample.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Sample hotel business data output in Excel" />
