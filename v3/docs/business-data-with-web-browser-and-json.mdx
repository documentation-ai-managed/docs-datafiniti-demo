---
title: Business Data with Web Browser and JSON
---
...
`https://AAAXXXXXXXXXXXX:@api.datafiniti.co/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels AND country:US&download=true`
