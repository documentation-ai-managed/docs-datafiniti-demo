---
title: Business Data with cURL and CSV
---
...
Within the `records` field, you'll see a single business returned with multiple fields and their values associated with that hotel.  The JSON response will show all fields that have a value.  It won't show any fields that don't have a value.
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452655873-f0hmxg6y8du-eeb2bad-hotel_sample.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Sample hotel business data output in Excel" noCaption />
