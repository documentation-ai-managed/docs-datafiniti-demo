...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452665109-76yy2coxnjq-0f7198e-auth_v3.jpg?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="V3 API authentication" noCaption />

Here's the same request in the V4 API:

<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452666164-r5al65frb9r-6860a81-auth_v4.jpg?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="V4 API authentication" noCaption />
...
<Columns cols="3">
  <Card title="Getting started with Business Data" href="/docs/getting-started-with-business-data" icon="building" horizontal="false">
    Walk through business data search and download requests using the V4 API.
  </Card>

  <Card title="Getting started with Product Data" href="/docs/getting-started-with-product-data" icon="shopping-cart" horizontal="false">
    Walk through product data search and download requests using the V4 API.
  </Card>

  <Card title="Getting started with Property Data" href="/docs/getting-started-with-property-data" icon="house" horizontal="false">
    Walk through property data search and download requests using the V4 API.
  </Card>
</Columns>
