---
title: Business Data with cURL and JSON
---
...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels+AND+country:US&download=true'
```

After running this command, you'll something like:
...
```curl
curl 'http://datafiniti-downloads-qa.s3.amazonaws.com/AAAXXXXXXXXXXXX/6073_1.txt?AWSAccessKeyId=AKIAIXQMCWHOZB3O35SA&Signature=2YtBsW9xY8CZrWDECcdLzyx4Jlk%3D&Expires=1484754763' > output.csv
```
