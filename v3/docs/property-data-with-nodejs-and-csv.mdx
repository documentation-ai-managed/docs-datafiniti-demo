---
title: Property Data with Node.js and CSV
---
...
3. We changed `properties_all` to `properties_all_nested`.  This will nest fields like prices and features into a single cell (instead splitting them across multiple rows and columns).
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452673305-7jwvxj9xizo-11f13d1-property_sample.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Sample property data output in Excel" noCaption />
