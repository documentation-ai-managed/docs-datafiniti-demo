---
title: Property Data with Postman and JSON
---
...
<ParamField path="/properties" param-type="string" required="false" deprecated="false">
...
`https://AAAXXXXXXXXXXXX:@api.datafiniti.co/v3/data/properties?view=properties_all&format=JSON&q=country:US AND categories:"Single Family Dwelling"&download=true`
