---
title: Property Data with Web Browser and CSV
---
...
2. Remove `&records=10`.
3. Change `properties_all` to `properties_all_nested`.  This will make sure each record is represented as a single row in the CSV file.
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452684571-594ocss4hcn-497bd6b-property_sample.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Sample property data output in Excel" noCaption />
