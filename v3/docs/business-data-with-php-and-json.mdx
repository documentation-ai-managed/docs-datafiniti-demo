---
title: Business Data with PHP and JSON
---
...
<ParamField query="q" param-type="string">
  The `q` tells the API what query you want to use.  In this case, you're telling the API you want to search by `categories`.  Any product that has `hotels` listed in its `categories` field will be returned.
