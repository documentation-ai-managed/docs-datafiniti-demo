---
title: Discover when clients sell their homes
---
...
<Steps>
  <Step title="Provide a list of your clients' addresses">
  ...
  <Step title="Build a script that checks the current status of each address">
  ...
  <Step title="Use the updated client file to run a campaign">
