...
Datafiniti runs an address normalization process across our entire business and business database. We normalize our addresses to a 2-character abbreviation USPS standard. You can find out more about this process [Normalized Property Addresses](/docs/normalized-address-data).
</Callout>
