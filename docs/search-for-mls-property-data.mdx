...
You can add additional filters, as long as they reference valid [property data schema fields](/docs/property-data-schema). For instance, you might want to only download record that fit a particular price range or current status. You can filter by `mostRecentStatus` or by `mostRecentSaleListPriceAmount`.
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775451170401-wzyr1qdt1ki-3dbcd1294d4b5dabf360c5d5a399cae34acf633aa217d354dbbd6b3f8d0e815d-image.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Screenshot showing target specific neighborhoods" noCaption />
