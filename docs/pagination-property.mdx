...
The pagination endpoint is very similar to the [search endpoint](/docs/property-data-with-curl#3-run-your-first-search).  Here's an example request:
...
<Columns cols="2">
  <Card title="Find property with a lien" href="/docs/find-property-with-liens" icon="alert-triangle" horizontal="false">
    Identify properties with active liens using paginated search queries.
  </Card>

  <Card title="How Credits Work" href="/docs/how-credits-work-1" icon="coins" horizontal="false">
    Understand how API credits are consumed during pagination and data retrieval.
  </Card>
</Columns>
