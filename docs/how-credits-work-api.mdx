...
GET [ https://api.datafiniti.co/v4/account]( https://api.datafiniti.co/v4/account)
...
However if you have a custom plan or need help figuring out your data plan please contact [billing@datafiniti.co](mailto:billing@datafiniti.co)

## Find your credits used

You can also use your GET [https://api.datafiniti.co/v4/account](https://api.datafiniti.co/v4/account) to check your credits used of your account.\
...
For more information on [Enrichment & Suppression](/docs/enrichment-suppression), you can read more about it here.

<Callout kind="danger" collapsed="false">
  Since Enrichment charge credit per the batch file you are enriching data from, you may be overcharged credits to your account upon submitting a enrichment request. If you do not know if overcharging is enable / disable on your account you may contact [support@datafiniti.co](mailto:support@datafiniti.co) to find this info out.
</Callout>
...
Whether it be via postman, our [Property Data](/reference/properties) reference page, or any other coding language, you will receive a 400 error message when your credit limit will be reached. The error message will look like this.
...
<Callout kind="danger" collapsed="false">
  If you plan to exceed your credit limit, please contact your Datafiniti customer success representative for refreshing or upgrade your accounts credit limit. Contact us at [support@datafiniti.co](mailto:support@datafiniti.co) to find this info out.
</Callout>
