...
<ResponseField name="total_cost" field-type="string" required="false" deprecated="false">
  The total number of credits used by this download.  Business records only cost 1 credit per record.
</ResponseField>
...
<Image src="https://files.readme.io/e200451-people.png" width="1920" height="1080" alt="Sample people data output" />
...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [JSON guides](/docs/getting-started-with-product-data) provide instructions on how to process this data.
