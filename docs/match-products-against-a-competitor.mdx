---
title: Match products against a competitor
---
...
You can also use Datafiniti's Enrichment API to pass in an entire file to enrich.  For more information on how to do this, refer to the [Enrichment API documentation](/docs/property-data-with-postman-and-json).
