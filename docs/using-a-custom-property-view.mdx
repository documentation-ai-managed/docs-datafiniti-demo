...
This method will create a permanent view that you can declare by name in the view of your search body. Using the [https://api.datafiniti.co/v4/views](https://api.datafiniti.co/v4/views) API endpoint you can create a view. We will use the previous fields as our view body. We will name this view `custom_transaction_view`.
...
Be sure that you declare the correct dataType to the dataType you wish to search. As we need to match the API to the dataType's schema. Learn more about [Property Data Schema](/docs/property-data-schema).
</Callout>
