---
title: "Create & save a custom product view"
---
...
* [Product Data Schema](/docs/product-data-schema)

We will use the [https://api.datafiniti.co/v4/views](https://api.datafiniti.co/v4/views) API endpoint to create this view. We will use the following top level product fields to create a view that only provides these fields upon an API search/enrichment/suppression request.
