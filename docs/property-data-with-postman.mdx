...
1. Find which states have the most expensive homes.

2. Sort the data by state.

3. Collect data on homes.

**Your environment and data needs:**

1. You want to work with CSV or JSON data.

2. You're working with Postman.
...
1. It adds `"format":"CSV",` to the code for outputting a csv format in the response.

2. It changes `records=1` to `records=10` so we can look at more sample matches.

3. It adds ` AND propertyType:"Single Family Dwelling"` to narrow down results to just US hotels.
...
1. We added `"download": true`.  This tells the API to issue a download request instead of a search request.
...
<Callout kind="alert" collapsed="false">
  **Credit limit monitoring**
  ...
  When using the API, you will not receive any warning if you are going past your monthly record limit.  Keep a track on how many records you have left by checking your account.  You are responsible for monitoring your monthly limit. To learn more about your credit limit please review [How Credits Work](/docs/how-credits-work-api).
</Callout>
...
<Image src="https://files.readme.io/b8b08d6f8ae5cdf1c77c8c56b6da899a6c006ce27fb76ddfb795aaf0a4f3b50b-image.png" width="1920" height="1080" alt="Screenshot showing open the result file(s) in excel" />
