---
title: Constructing People Queries
---
...
You can do similar queries on any of the fields in the [people schema](/docs/people-data-schema).  Here's an example that queries the `businessName` field:
...
As an alternative or used for testing purposes you can set your `num_records` to 0 in your people search query. This is will only return the `num_found` of the query and will cost 0 credits to search.
