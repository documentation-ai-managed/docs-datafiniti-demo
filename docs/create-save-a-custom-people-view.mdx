---
title: "Create & save a custom people view"
---
...
* [People Data Schema](/docs/people-data-schema)

We will use the [https://api.datafiniti.co/v4/views](https://api.datafiniti.co/v4/views) API endpoint to create this view. We will use the following top level people fields to create a view that only provides these fields upon an API search/enrichment/suppression request.
...
You can also visit the API reference page [here ](/reference/people-data)to test your new view or you can download the postman suite [here](/docs/people-data-with-postman-json).
