...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452315495-cu4qwnc71jp-09308c19ef5679c6c442944d6110ca679093450ba9364b1caa8aaa05b67cb768-image.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Screenshot showing 2. get your api token" noCaption />
...
| `"records"` | The first available matches to your query. If there are no matches, this field will be empty. <br /> Within each record returned, you'll see multiple fields shown.  This is the data for each record. |
...
Each business record will have multiple fields associated with it.  You can see a full list of available fields in our [Property Data Schema](/docs/property-data-schema).
...
Since we've handled multiple steps of the download process in this code, we won't go into the details here, but we do recommend you familiarize yourself with those steps.  Checking them out in our [Property Data with Postman and CSV](/docs/property-data-with-postman) guide.
...
```json
{
    ...
    "fields": [
        ...
        {
            "name": "civilDivisionCode"
        },
        {
            "name": "civilDivisionName"
        },
        {
            "name": "companies",
            "flatten": false,
        ...
        {
            "name": "congressionalDistrictHouse"
        },
        {
            "name": "country"
        },
    ...
    "user": 1226609,
    "results": [],
    "date_started": "2025-01-23T19:52:25.044Z",
    "date_updated": "2025-01-23T19:52:25.044Z",
    "_id": 710516,
...
You can track the status of your download via the following method using our GET [https://api.datafiniti.co/v4/downloads/:id](https://api.datafiniti.co/v4/downloads/:id) endpoint
...
For more information please read our [Downloading Result Files](/docs/downloading-result-files).\
You can match the ID from your API response to the download ID on the page here:

<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452309703-ithjo0l55o-e048f51d3f77560a7a3803356c4350802c0f3386c89d25c67dd180c95804c747-image.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Screenshot showing track your download via the portal" noCaption />

### Track via our reference page

You can track the status of your Datafiniti download via the API reference page [Get a Download](/reference/get-a-download). You can match the ID from your API response to the download ID on the page here:

<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452311343-jwg6rrvpzxq-c5707f6b7aca415216ec57d58c5047fdedece72db0596e3c7d3ae88cb8c7d35a-image.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Screenshot showing track via our reference page" noCaption />
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452313714-6a82pgruus-b8b08d6f8ae5cdf1c77c8c56b6da899a6c006ce27fb76ddfb795aaf0a4f3b50b-image.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Screenshot showing open the result file(s) in excel" noCaption />
