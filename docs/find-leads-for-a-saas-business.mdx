---
title: Find leads for a SaaS business
---
...
This will generate a CSV file with each field in our [people data schema](/docs/people-data-schema) in a separate column.
