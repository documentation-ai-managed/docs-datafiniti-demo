---
title: Generate a list of recent broker contacts
---
...
This view can be created using our [https://api.datafiniti.co/v4/views](https://api.datafiniti.co/v4/views) POST API endpoint.
...
[Views](/docs/property-data-views)
</Callout>
