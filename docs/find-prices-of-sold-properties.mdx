---
title: Find prices of sold properties
---
...
Shown here is a sample of the transaction data to expect. To learn more please read the transaction field of [Property Data Schema](/docs/property-data-schema)
...
Let's add a filter for a single family home. For more information on the possible `propertyTypes `you can visit here [Possible Values for Property Fields](/docs/possible-values-for-property-fields)
