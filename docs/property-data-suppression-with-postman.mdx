---
title: Property Data Suppression with CSV
---
...
Let's assume you are searching for property in Austin, Texas US and you have already downloaded 20 records here:
...
<Callout kind="alert">
  ...
  **Common Error**
  ...
  If the file name is not labeled as excluded *address.txt* the API will return the following 400 error code:
...
Next, we will open the Datafiniti api library in Postman. For how to get the Postman library, you can use this guide here: [Postman Guide](/docs/postman-endpoint-overview) Once open we will use the following query to look for `single family dwelling` in Austin Texas, US.
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775451140481-54o16l3zlov-61513ca-image.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Postman suppression API call setup" noCaption />
...
You can check your download status by the following guide here: [Postman: Download Result Files](/docs/postman-downloading-result-files)
