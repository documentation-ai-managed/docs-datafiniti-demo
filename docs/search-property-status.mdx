---
title: Search on property statuses
---
...
We recommend users view our possible status type values page [here ](/docs/possible-values-for-property-fields)to determine the exact string to search property data for.
</Callout>
