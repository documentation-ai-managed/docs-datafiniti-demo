---
title: Identify e-commerce orders shipping to vacant houses
---
...
<Steps>
  <Step title="Collect a list of recent shipping addresses">
  ...
  <Step title="Check an MLS address against Datafiniti">
  ...
  <Step title="Flag properties recently listed or sold">
