...
For this guide, we're going to assume the following you're interested in using Datafiniti's property data enrichment to enrich an existing csv file of commercial addresses in Texas, US.

<Steps>
  <Step title="Select your enrichment file">
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452554220-6kcfy85ghio-29275a3-enrichpropertiescsv.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Property enrichment CSV configuration" noCaption />

  </Step>
  <Step title="Set your field_parameter(s)">
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452555319-hic7jjf7734-bdc1f80-enrichmentcsvFieldParams.gif?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Setting enrichment CSV field parameters" noCaption />
...
<Callout kind="danger">
  ...
  **Num_records**
  ...
  If your query does not find 20 records your account will only be charged per record found.
...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452556860-b3jv9bfhwz4-292c6b1-enrichpropertiesquery.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Property enrichment query configuration" noCaption />
...
<Callout kind="alert">
  ...
  **Query - download time**
  ...
  <Step title="Configure your format & view">
...
Finally the view is used to specify which fields you want added to your data. If no view is provided, we will add all fields from matching records as we do for our ***default*** view for the [Available Views for Property Data](/docs/available-views-for-property-data)

Your finally parameter should be setup as the following.

<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452558076-odm5cxx6e5n-0ac0eaf-enrichpropertiesformat.png?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="Property enrichment format and view configuration" noCaption />
