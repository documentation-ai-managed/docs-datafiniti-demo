...
* Some field names have changed in order to abide by a consistent naming convention. You can view the updated product schema [here](https://developer.datafiniti.co/docs/property-data-schema).
