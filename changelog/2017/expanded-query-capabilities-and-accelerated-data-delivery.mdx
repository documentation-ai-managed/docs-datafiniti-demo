---
title: "February 6, 2017 — Product Data Elasticsearch Migration"
---
...
* Previously, quick successive API calls could result in dramatically different estimated\_total values, which was confusing.  Our new backend shows the same estimated\_total value each time for the same API call (barring any additions to the database).
